...
# plot station's signal on nine main bands (80/40/20/15/10), for the six zones with the most RBN posts

# plot-sig-zones-9.R call start-date end-date
# e.g.,
# plot-sig-zones-9[.R] N7DR 20111126 20111126
...
png(filename=paste(sep="", safe_call, "-", start, "-", end, "-by-zone-9.png"),  width=800, height=600)
